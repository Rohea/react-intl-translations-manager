...
var _getDefaultMessages2 = require('./getDefaultMessages');

var _getDefaultMessages3 = _interopRequireDefault(_getDefaultMessages2);
...
exports.default = function (_ref) {
  ...
  var defaultCoreMethods = {
    ...
    getDefaultMessages: function getDefaultMessages(files) {
      return (0, _getDefaultMessages3.default)(files, { overrideMessage: overrideMessage });
    },
    ...
    provideTranslationsFile: function provideTranslationsFile(lang) {
      var filePath = _path2.default.join(translationsDirectory, lang + '.json');
      var jsonFile = (0, _readFile2.default)(filePath);
      return jsonFile ? JSON.parse(jsonFile) : undefined;
    },

    provideWhitelistFile: function provideWhitelistFile(lang) {
      var filePath = _path2.default.join(whitelistsDirectory, 'whitelist_' + lang + '.json');
      var jsonFile = (0, _readFile2.default)(filePath);
      return jsonFile ? JSON.parse(jsonFile) : undefined;
    },

    getLanguageReport: _getLanguageReport2.default,
